...
public class BatchApiResource {
    ...
    @ApiImplicitParams({@ApiImplicitParam(paramType = "body", dataType = "BatchRequest", required = true, type = "body", dataTypeClass = BatchRequest.class, value = "")})
    @ApiResponse(code = 200, message = "Success", response = BatchResponse.class)
