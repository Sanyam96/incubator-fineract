...
public class ClientAddressApiResources {
	...
	@ApiImplicitParams({@ApiImplicitParam(value = "body", required = true, paramType = "body", dataType = "body", format = "body", dataTypeClass = ClientAddressApiResourceSwagger.PostClientClientIdAddressesRequest.class)})
	@ApiResponses({ @ApiResponse(code = 200, message = "OK", response = ClientAddressApiResourceSwagger.PostClientClientIdAddressesResponse.class)})
	...
	@ApiResponses({@ApiResponse(code = 200, message = "OK", responseContainer = "List", response = ClientAddressApiResourceSwagger.GetClientClientIdAddressesResponse.class)})
	...
	@ApiImplicitParams({@ApiImplicitParam(value = "body", required = true, paramType = "body", dataType = "body", format = "body", dataTypeClass = ClientAddressApiResourceSwagger.PutClientClientIdAddressesRequest.class)})
	@ApiResponses(value = { @ApiResponse(code = 200, message = "OK", response = ClientAddressApiResourceSwagger.PutClientClientIdAddressesResponse.class)})
