...
public class GLClosuresApiResource {
    ...
    @ApiResponse(code = 200, response = GLClosureData.class, message = "")
    ...
    @ApiImplicitParams({@ApiImplicitParam(value = "body", dataType = "body", dataTypeClass = GLClosureData.class)})
